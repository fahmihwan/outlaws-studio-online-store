        ...
        <div id="mega-menu-full" class="  hidden  justify-between   w-full md:flex md:w-auto md:order-1 ">
            <ul class="flex flex-coltext-sm font-medium md:flex-row md:space-x-8 md:mt-0">
                ...
                <li class=" flex items-center">
                    ...
                    <!-- drawer Cart -->
                    <div id="drawer-cart"
                        class="fixed z-40 p-0  bg-gray-100 w-96 transition-transform right-0 top-0 translate-x-full"
                ...
                <li>
                    ...
                    <div id="drawer-right-example"
                        class="fixed z-40 h-screen overflow-y-auto bg-white w-2/5   transition-transform right-0 top-16 translate-x-full"
                        tabindex="-1" aria-labelledby="drawer-right-label" aria-hidden="true">
