            ...
            <ul
                ...
                <li class="w-1/2 md:w-full">
                    <a href="/admin/master-item/kategori"
                        class="inline-block  p-4 w-full text-gray-900 bg-gray-200  active  " aria-current="page">
                        Kategori
                    </a>
                </li>
                <li class="w-1/2 md:w-full ">
                            ...
                            <div class="relative p-0 w-full max-w-md h-full md:h-auto">
                                ...
                                <div class="relative bg-white rounded-lg shadow ">
                                    ...
                                    <div class="py-6 px-6 lg:px-8">
                                        <h3 class="mb-4 text-xl font-medium text-gray-900 ">Tambah Kategori
                                        </h3>
                                        <form action="/admin/master-item/kategori" method="POST" class="space-y-6">
                                            @csrf
                                            <div>
